            ...
            switch (command) {
                ...
                case "deadline":
                    ...
                    try {
                        deadline = new Deadline(
                                deadlineParts[0],
                                LocalDateTime.parse(deadlineParts[1], DatetimeHelper.INPUT_FORMATTER));
                ...
                case "event":
                    ...
                    try {
                        ...
                        event = new Event(
                                eventParts[0],
                                LocalDateTime.parse(dateParts[0], DatetimeHelper.INPUT_FORMATTER),
                                LocalDateTime.parse(dateParts[1], DatetimeHelper.INPUT_FORMATTER));
                    } catch (ArrayIndexOutOfBoundsException e) {
                        throw new BobException(
                                """
